  ...
  window._openAirtimeNetSheet = function() {
    window.openBottomSheet({
      ...
      onSelect: function(item) {
        ...
        if (imgEl) imgEl.innerHTML = '<img src="'+item.img+'" style="width:100%;height:100%;border-radius:10px;object-fit:contain;" onerror="this.outerHTML=\'<span style=\\'font-size:1.1rem;line-height:1;\\'>📱</span>\'">';
      }
    });
  };
