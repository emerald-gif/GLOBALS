...
function showTaskDetails(jobId, jobData) {
  ...
  fullScreen.innerHTML = `
    <div class="max-w-2xl mx-auto space-y-6">
      ...
      <button class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm mt-4">
        Submit Task
      </button>
    </div>
  `;
