...
/* getStoreSlugFromHost removed — using path routing */
...
/* Subdomain middleware removed — using /s/:slug path instead */




/* ---------- GET /s/:slug — public store short path ---------- */
app.get('/s/:slug', (req, res) => {
  const slug = req.params.slug;
  if (!slug || !/^[a-z0-9]{2,10}$/.test(slug)) return res.status(404).send('Store not found.');
